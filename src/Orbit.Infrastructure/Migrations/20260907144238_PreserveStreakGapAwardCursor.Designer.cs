...
namespace Orbit.Infrastructure.Migrations
{
    ...
    [Migration("20260907144238_PreserveStreakGapAwardCursor")]
    partial class PreserveStreakGapAwardCursor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.AgentAuditLog", b =>
                {
                    ...
                    b.Property<string>("ShadowPolicyDecision")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.AgentStepUpChallengeState", b =>
                {
                    ...
                    b.Property<Guid>("PendingOperationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.AiUsageDaily", b =>
                {
                    ...
                    b.HasIndex("Date", "Model", "Purpose", "UserId")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("Date", "Model", "Purpose", "UserId"), false);
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.GoalProgressLog", b =>
                {
                    ...
                    b.HasIndex("GoalId", "UpdatedAtUtc");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.Habit", b =>
                {
                    ...
                    b.Property<int?>("OriginalDayOfMonth")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.HabitLog", b =>
                {
                    ...
                    b.HasIndex("HabitId", "UpdatedAtUtc");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.PendingAgentOperationState", b =>
                {
                    ...
                    b.Property<string>("ConfirmationRequirement")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<DateTime?>("StepUpSatisfiedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("UserId", "OperationFingerprint");

                    b.ToTable("PendingAgentOperations");
                });

            modelBuilder.Entity("Orbit.Domain.Entities.PendingClarification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MissingArgumentKey")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("PartialArgumentsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.ProcessedRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.SentProactiveCheckin", b =>
                {
                    ...
                    b.ToTable("SentProactiveCheckins");
                });
            ...
            modelBuilder.Entity("Orbit.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("GoogleCalendarSelectedIds")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("HasCompletedOnboardingChecklist")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasCompletedTour")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasCreatedFirstHabit")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateOnly?>("LastAdRewardLocalDate")
                        .HasColumnType("date");
                    ...
                    b.Property<int?>("PreGapFreezeAwardStreak")
                        .HasColumnType("integer");

                    b.Property<DateOnly?>("PreGapLastActiveDate")
                        .HasColumnType("date");

                    b.Property<bool>("ProactiveAstraEnabled")
                        .HasColumnType("boolean");
